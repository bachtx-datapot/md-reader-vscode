...
**Evidence Report (MANDATORY — append to test report):**
```
...
- Files tested: {list}
- Gaps found: {list of untested scenarios}
- BDD scenarios covered: {N}/{total}

## Scenario Audit
| Service/Procedure | Happy | Validation | Not-Found | Auth | Business Rule |
|-------------------|-------|------------|-----------|------|---------------|
