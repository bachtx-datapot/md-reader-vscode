...
## Business Pipeline (Phase 1-2)

3-layer architecture for CEO brief → approved requirements. Full protocol → `.claude/agents/business-engineer.md`.

Templates → `plans/templates/business/` (5 templates: impact-map, brief, process-review, user-stories, prd).
